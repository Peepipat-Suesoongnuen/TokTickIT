...
// Pre-migration verification helper. The DevelopmentRequester model is intentionally
// KEPT as frozen legacy until the #45/#46 auth cutover drops the table together
// with the requester-selector routes, so the check runs via $queryRaw
