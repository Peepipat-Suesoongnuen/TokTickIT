...
| API-11 | API | AC-14, BR-21 | Default updatedAt DESC + id DESC; priority rank; Ticket Number ASC/DESC; existing Ticket Date support | Ordering matches contract | server/tests/lab-02/my-tickets.api.test.ts | Planned |
...
| AC-28 | UI-19, UI-25, A11Y-01, VISUAL-01 |
